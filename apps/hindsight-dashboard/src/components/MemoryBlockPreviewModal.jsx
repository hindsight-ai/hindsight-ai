...
const MemoryBlockPreviewModal = ({ isOpen, onClose, memoryBlockId }) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    {memoryBlock.updated_at && (
                      <div>
                        <label className="block text-sm font-medium text-gray-700">Last Updated</label>
                        <p className="text-sm text-gray-600">{formatDate(memoryBlock.updated_at)}</p>
                      </div>
                    )}
                  </div>
                </div>
                ...
                {memoryBlock.feedback_score !== undefined && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`font-semibold ${
                      memoryBlock.feedback_score >= 80 ? 'text-green-600' :
                      memoryBlock.feedback_score >= 60 ? 'text-yellow-600' : 'text-red-600'
                    }`}>
