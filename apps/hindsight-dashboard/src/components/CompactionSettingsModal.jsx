...
const CompactionSettingsModal = ({ 
  ...
  const [selectedCount, setSelectedCount] = useState(Math.min(50, maxBlocks)); // Default to 50 or max available
  const [userInstructions, setUserInstructions] = useState('');
  const [maxConcurrent, setMaxConcurrent] = useState(4); // Default to 4 concurrent processes
