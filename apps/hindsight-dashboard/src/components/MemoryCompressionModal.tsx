...
import { MemoryCompactionResult } from './MemoryCompactionModal';

interface MemoryCompressionModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const MemoryCompressionModal: React.FC<MemoryCompressionModalProps> = ({
  isOpen,
  onClose,
  memoryBlock,
  onCompactionApplied
...
export default MemoryCompressionModal;
