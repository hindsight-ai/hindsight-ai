...
const MemoryBlocksPage = () => {
  ...
  const [selectedMemoryBlockId, setSelectedMemoryBlockId] = useState(null);
  ...
  const handleViewMemoryBlock = (id) => {
  ...
  const handleArchiveMemoryBlock = async (id) => {
  ...
  const handleDeleteMemoryBlock = async (id) => {
  ...
  const handleSuggestKeywords = async (id) => {
    try {
  ...
  const handleCompactMemory = async (id) => {
  ...
  const hasActiveFilters = searchTerm || agentFilter || conversationFilter;
