        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative inline-flex items-center justify-center w-9 h-9 rounded-full bg-amber-400 hover:bg-amber-500 text-white shadow-md hover:shadow-lg transition-all duration-200 transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-amber-300"
            >
              {/* Coffee cup icon */}
