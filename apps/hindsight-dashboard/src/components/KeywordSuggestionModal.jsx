...
const KeywordSuggestionModal = ({ isOpen, onClose, suggestions, onApply, disabled = false }) => {
  ...
  const toggleKeywordSelection = (blockId, keyword) => {
  ...
  const handleApply = async () => {
    ...
    try {
      ...
      notificationService.showError('Failed to apply keywords: ' + error.message);
    } finally {
      setLoading(false);
    }
  };
