...
const TokenManagement: React.FC = () => {
  ...
  const { create, oneTimeSecret, clearOneTime } = useTokenCreation();
      ...
      {oneTimeSecret && (
        <div className="mb-4 p-3 border rounded bg-yellow-50 text-yellow-800">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="ml-auto text-sm text-blue-600 hover:underline" onClick={() => clearOneTime()}>Dismiss</button>
          </div>
        </div>
      )}
