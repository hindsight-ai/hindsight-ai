...
interface MemoryBlockFilterBarProps {
  filters: FiltersState;
  searchTerm: string;
  agentIdInput: string;
  onFilterChange: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void;
  onRangeFilterChange: (name: string, value: number | [number, number]) => void;
  onKeywordChange: (selectedKeywords: string[]) => void;
  onAgentIdApply: (agentId: string) => void;
...
const MemoryBlockFilterBar: React.FC<MemoryBlockFilterBarProps> = ({
  filters,
  searchTerm,
  agentIdInput,
  onFilterChange,
          ...
          <div className={`filter-group id-filters ${filters.agent_id || filters.conversation_id ? 'active-filter' : ''}`}>
            ...
            <input
              ...
              onKeyDown={(e: React.KeyboardEvent<HTMLInputElement>) => {
                if (e.key === 'Enter') {
                  onAgentIdApply((e.target as HTMLInputElement).value);
                }
              }}
